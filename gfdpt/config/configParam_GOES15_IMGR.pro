;---------------------------------------------------------------------------------
; Name:  configParam_GOES15_IMGR.pro
;
; Type:  IDL Program
;
; Description:
;   To config parameters for GOES15 IMAGER
...
;
;---------------------------------------------------------------------------------
PRO configParam_GOES15_IMGR, paramStruct
   ...
   paramStruct.radListFile1 = 'goeslist/meas.g15idall'
   paramStruct.radListFile2 = 'goeslist/fwd.g15idall'
   paramStruct.sceneListFile = 'goeslist/scene.g15idall'

   paramStruct.radlistfile1='/disks/data086/emaddy/dat/observation_assessment_tool//scripts/lists/obs_rad_20141005_goes15_imgr.list'
   paramStruct.scenelistfile='/disks/data086/emaddy/dat/observation_assessment_tool//scripts/lists/NWP_ECMWF_20141005_goes15_imgr.list'
   paramStruct.radlistfile2='/disks/data086/emaddy/dat/observation_assessment_tool//scripts/lists/FWD_NWP_ECMWF_20141005_goes15_imgr.list'

   paramStruct.sensorName = 'G15_IMGR'
   paramStruct.sensorID = 'G15'
   paramStruct.imageDir     = './images/g15_imgrdall/'
