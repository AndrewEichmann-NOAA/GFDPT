...
#
#  This script is to run grid2grid Fortran executable grid2grid.gfs.ecmwf.x
...
# run grid2grid.gfs.ecmwf.x executable ##############################################                                                                                                                                                             
$homeexec/grid2grid.gfs.ecmwf.x < g2g.ctl.$model > output.$model
