...
sh /gpfs/hps3/emc/global/noscrub/Andrew.Eichmann/GFDPT/code/dev/scripts/gribextremes/setup.sh
#####################################################################
...
###   export input_ecmwf=$grib_ecma/${ecmhead}$mmdd$fcyc$mmdd${cyc}001
   export input_ecmwf=$grib_ecma/${ecmhead}$mmdd$fcyce$mmdd${cyc}001
