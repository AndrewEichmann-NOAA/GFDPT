...
$wgrib='/gpfs/hps3/emc/global/noscrub/Fanglin.Yang/VRFY/vsdb/nwprod/util/exec/wgrib';
...
$pdef_dir='/global/save/Krishna.Kumar/r2o/fcstdiv/grads';
...
#  print wind rotation
   ...
   print "xdef 1800 linear -180 0.1\n";
   print "ydef 905 linear 0 0.1\n";
}
elsif ($grid == 192 && $test_rr ne "") {
   # quick and dirty pdef for RR egrid
   # need -rrr option to use
   print "pdef 237 387 eta.u -111 50 0.4491525  0.2072539\n";
# gd  print "xdef 360 linear -180 0.5\n";
# gd   print "ydef 181 linear 0 0.5\n";
   print "xdef 1800 linear -180 0.1\n";
   print "ydef 905 linear 0 0.1\n";
}
