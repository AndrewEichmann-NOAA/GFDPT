...
;
;---------------------------------------------------------------------------------
PRO configParam_GOES13_SNDR, paramStruct
   ; Set map range to plot
   paramStruct.MIN_LAT = 0.
   paramStruct.MAX_LAT = 90
   paramStruct.MIN_LON = -180
   paramStruct.MAX_LON = -30
   ...
   paramStruct.radListFile1 = 'goeslist/meas.g13d1'
   paramStruct.radListFile2 = 'goeslist/fwd.g13d1'
   paramStruct.sceneListFile = 'goeslist/scene.g13d1'
   paramStruct.sensorName = 'G13_SNDRD1'
   paramStruct.sensorID = 'G13D1'
   paramStruct.imageDir     = './images/g13_sndrd1/'

   ; all detectors GOES SNDR 
   paramStruct.radListFile1 = 'goeslist/meas.g13dall'
   paramStruct.radListFile2 = 'goeslist/fwd.g13dall'
   paramStruct.sceneListFile = 'goeslist/scene.g13dall'
   paramStruct.sensorName = 'G13_SNDR'
   paramStruct.sensorID = 'G13'
   paramStruct.imageDir     = './images/g13_sndrdall2/'
