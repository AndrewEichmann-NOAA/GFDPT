...
!    10-08-2014         Eric S. Maddy, RTi @ NOAA/NESDIS
!                       added info for IR (GOES, AIRS, IASI, CrIS)
!    10-17-2014         Eric S. Maddy added MW for trace gases (CO, CO2, CH4, N2O)
...
MODULE Consts
  ...
  REAL,                    PARAMETER :: MW_CO              = 28.01010      !  g/mol    | Molecul Weight of CO   |
  REAL,                    PARAMETER :: MW_CO2             = 44.00950      !  g/mol    | Molecul Weight of CO2  |
  REAL,                    PARAMETER :: MW_CH4             = 16.04246      !  g/mol    | Molecul Weight of CH4  |
  REAL,                    PARAMETER :: MW_N2O             = 44.01288      !  g/mol    | Molecul Weight of N2O   |
  ...
  INTEGER,                 PARAMETER :: SENSOR_ID_IR       = 50                   !   -       | Sensor ID for first IR instrument |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G13 = SENSOR_ID_IR         !   -       | Sensor ID for GOES SNDR G13 |
  INTEGER,                 PARAMETER :: SENSOR_ID_IMGR_G13 = SENSOR_ID_IR+1       !   -       | Sensor ID for GOES IMAG G13 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G15 = SENSOR_ID_IR+2       !   -       | Sensor ID for GOES SNDR G13 |
  INTEGER,                 PARAMETER :: SENSOR_ID_IMGR_G15 = SENSOR_ID_IR+3       !   -       | Sensor ID for GOES IMAG G15 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G13D1 = SENSOR_ID_IR+4     !   -       | Sensor ID for GOES SNDR G13D1 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G13D2 = SENSOR_ID_IR+5     !   -       | Sensor ID for GOES SNDR G13D2 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G13D3 = SENSOR_ID_IR+6     !   -       | Sensor ID for GOES SNDR G13D3 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G13D4 = SENSOR_ID_IR+7     !   -       | Sensor ID for GOES SNDR G13D4 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G15D1 = SENSOR_ID_IR+8     !   -       | Sensor ID for GOES SNDR G15D1 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G15D2 = SENSOR_ID_IR+9     !   -       | Sensor ID for GOES SNDR G15D2 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G15D3 = SENSOR_ID_IR+10    !   -       | Sensor ID for GOES SNDR G15D3 |
  INTEGER,                 PARAMETER :: SENSOR_ID_SNDR_G15D4 = SENSOR_ID_IR+11    !   -       | Sensor ID for GOES SNDR G15D4 |
  INTEGER,                 PARAMETER :: SENSOR_ID_AIRS       = SENSOR_ID_IR+20    !   -       | Sensor ID for AIRS |  
  INTEGER,                 PARAMETER :: SENSOR_ID_METOPA_IASI = SENSOR_ID_IR+21   !   -       | Sensor ID for IASI METOPA |  
  INTEGER,                 PARAMETER :: SENSOR_ID_SNPP_CRIS   = SENSOR_ID_IR+22   !   -       | Sensor ID for CRIS SNPP |  
  INTEGER,                 PARAMETER :: SENSOR_ID_METOPB_IASI = SENSOR_ID_IR+23   !   -       | Sensor ID for IASI METOPB |  
  INTEGER,                 PARAMETER :: SENSOR_ID_HIMAWARI8_AHI = SENSOR_ID_IR+24 !   -       | Sensor ID for H8 AHI IR |  
  INTEGER,                 PARAMETER :: SENSOR_ID_SNPP_ALL   = SENSOR_ID_IR+25    !   -       | Sensor ID for SNPP CRIS and ATMS |  
  INTEGER,                 PARAMETER :: SENSOR_ID_METOPB_AVHRR = SENSOR_ID_IR+26  !   -       | Sensor ID for AVHRR METOPB |
  ...
  CHARACTER(LEN=4),        PARAMETER :: SATID_AIRS         = 'aqua'        !   -       / String ID for AIRS      /
  CHARACTER(LEN=6),        PARAMETER :: SATID_GOES13       = 'goes13'      !   -       / String ID for GOES13      /
  CHARACTER(LEN=6),        PARAMETER :: SATID_GOES15       = 'goes15'      !   -       / String ID for GOES15      /
  CHARACTER(LEN=9),        PARAMETER :: SATID_HIMAWARI     = 'himawari8'   !   -       / String ID for H8      /
  ...
  INTEGER,                 PARAMETER :: MAXABSORB          = 6             !   -       | CRTM Max # absorbers   |
  !--------------------------------------------------------------------------------------------
  !  Dependent constants
  !--------------------------------------------------------------------------------------------  
