!$Id: PreClassif.f90 3341 2013-10-09 17:25:25Z amims $
!-----------------------------------------------------------------------------------------------
! Name:         Preclassif
! 
! Type:         F90 module
...
!===============================================================
  ...
  SUBROUTINE SURFACE_CLASSIFICATION_ALG(Year,Julday,SENSOR_ID,NCHAN,FREQ,TA,LATITUDE,LONGITUDE,LAND_INDEX,&
    ...
    IF (SENSOR_ID == sensor_id_f16)     &
        CALL F16_SSMIS_ALG(Year,Julday,NCHAN,FREQ,LATITUDE,LONGITUDE,LAND_INDEX,TA,NSURFACE_TYPE,TskPreclass)
    ...
    IF (SENSOR_ID == sensor_id_gcomw1)   &
        CALL GCOMW1_AMSR2_ALG(Year,Julday,NCHAN,FREQ,LATITUDE,LONGITUDE,LAND_INDEX,TA,NSURFACE_TYPE,TskPreclass)
...
SUBROUTINE GCOMW1_AMSR2_ALG(Year,Julday,nchan,freq,lat,lon,landindex,ta,surface_type,TskPreclass)
    !--------------------------------------------------------------------------------
    !M+
    ! NAME:
    !       GCOMW1_AMSR2_ALG
    ...
    !   taw(1)       : antenna temperature at 6.925 VPOL GHz
    !   taw(2)       : antenna temperature at 6.925 HPOL GHz
    !   taw(3)       : antenna temperature at 7.300 VPOL GHz
    !   taw(4)       : antenna temperature at 7.300 HPOL GHz
    !   taw(5)       : antenna temperature at 10.65 VPOL GHz
    !   taw(6)       : antenna temperature at 10.65 HPOL GHz
    !   taw(7)       : antenna temperature at 18.70 VPOL GHz
    !   taw(8)       : antenna temperature at 18.70 HPOL GHz
    !   taw(9)       : antenna temperature at 23.80 VPOL GHz
    !   taw(10)      : antenna temperature at 23.80 HPOL GHz
    !   taw(11)      : antenna temperature at 36.50 VPOL GHz
    !   taw(12)      : antenna temperature at 36.50 VPOL GHz
    !   taw(13)      : antenna temperature at 89.00 VPOL GHz
    !   taw(14)      : antenna temperature at 89.00 HPOL GHz
    !
    ...
    data coe_ts/2.63055e+002,  2.24818e+000, -1.75953e+000, -2.46555e+000, -9.57587e-001,  &
               ...
               -5.06110e-003/
    ! Seven window channel indices used in the algorithm
    data wchan_index/7,8,9,11,12,13,14/
    !---Central Frequencies ct five window channel
    data freqw/18.7, 18.7, 23.8, 36.5, 36.5, 89.0, 89.0/
...
!     endif  ! non desert
 ...
 END SUBROUTINE GCOMW1_AMSR2_ALG
...
SUBROUTINE GPM_GMI_ALG(Year,Julday,nchan,freq,lat,lon,landindex,ta,surface_type,TskPreclass)
    ...
    ! INTERNAL VARIABLES:
    !
    !   taw          : GPM GMI antenna temperatures at 13 channels
    !
    ...
    !
    !   freqw        : GPM GMI frequencies at 13 
    !
    ! OUTPUT VARIABLES:
    !
    !   surface_type    : OC_TYP (OPEN OCEAN)
    ...
    !       and             Fuzhong Weng, NOAA/NESDIS/ORA, Fuzhong.Weng@noaa.gov
    !
    !                       Eric S. Maddy, RTi @ JCSDA, Eric.Maddy@noaa.gov (07-02-2014)
    !
    !
    !  Copyright (C) 2007 Fuzhong Weng and Banghua Yan
    !
