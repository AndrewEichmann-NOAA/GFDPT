...
MODULE CRTM_RTSolution
  ...
  '$Id: CRTM_RTSolution.f90 29405 2013-06-20 20:19:52Z paul.vandelst@noaa.gov $'
...
!      print *, SfcOptics%Emissivity(1:nZ,1)
!      print *, 'RT: ,ichan=', ChannelIndex, ',     emiss=',SfcOptics%Emissivity(1:nZ,1)
!      print *, 'RT: ,ichan=', ChannelIndex, ',     reflc=',SfcOptics%Reflectivity(1:nZ,1,1:nZ,1)
!      print *, ChannelIndex
!      print *, SfcOptics%Reflectivity(1:nZ,1,1:nZ,1)
